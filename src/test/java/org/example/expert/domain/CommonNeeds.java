...
public class CommonNeeds {
    ...
    public final static String TEST_PASSWORD1 = "Abcdefghijk1";
    ...
    public final static String TEST_PASSWORD2 = "Abcdefghijk1";
